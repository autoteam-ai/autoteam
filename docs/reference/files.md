...
| `.autoteam/planner.md` 等 4 个 | 角色指令，同步到 Multica | 人 | ✅ |
| `.autoteam/playbook.md` | 本项目的经验库，Planner 每次开工必读；由 Planner 提议、人批准 | 人 | ✅ |
| `.autoteam/planner-mcp.json` | Planner 的浏览器自动化（Playwright MCP，可选） | 人 | ✅ |
| `.autoteam/autopilots/*.md` | 10 个 autopilot 的触发配置和 runbook | 人 | ✅ |
